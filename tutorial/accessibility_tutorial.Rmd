...
be downloaded using the code below. Only run this chunk if you want to download the data for the entire GLA areas (not required for this practical exercise)
...
NOTE: At times, the automatic download of such large datasets results in a corrupted file. To avoid this issue, you must  download these two files manually and replace them in your data_inner folder.

To manually download the files, go to:
